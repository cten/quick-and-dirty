...
instances = ec2.create_instances(ImageId='ami-0099bd67', KeyName="challengekey", MinCount=1, MaxCount=1, SubnetId=subnet.id ,InstanceType="t2.micro", UserData='#!/bin/bash\ncurl ')
